...
//    gm->GetYaxis()->SetTitleSize(0.055);
//    gm->GetXaxis()->SetTitleSize(0.055);
...
/////////// PUBLSISH
//    TCanvas *cP = new TCanvas("cPublish","cPublish",1500,800);
...
//    gStyle->SetLabelSize(.055);
//
//    gm->SetTitle(" ;Invariant mass, m_{K#pi} [GeV/c^{2}];Counts");
//    gm->GetXaxis()->SetLabelSize(0.06);
//    gm->GetYaxis()->SetLabelSize(0.06);
//    gm->GetXaxis()->SetTitleSize(0.065);
//    gm->GetYaxis()->SetTitleSize(0.065);
//    gm->GetXaxis()->CenterTitle(kTRUE);
//    gm->GetXaxis()->SetTitleOffset(1.1);
//    gm->GetYaxis()->CenterTitle(kTRUE);
//
//    gm->Draw("apz");
//    TPaveText *textPub = new TPaveText(0.74,0.71,0.81,0.94,"brNDC");
//    textPub -> SetTextSize(0.05);
//    textPub -> SetLineColor(0);
//    textPub -> SetShadowColor(0);
//    textPub -> SetFillColor(0);
//    textPub -> SetTextFont(42);
//    textPub -> AddText("STAR Preliminary");
//    textPub -> AddText("d+Au #sqrt{s_{NN}} = 200 GeV");
//    textPub -> AddText(Form("%3.1f < p_{T} < %3.1f GeV/c", ptminText, ptmaxText));
//     TText *tP = textPub->GetLineWith("STAR");
//    tP->SetTextColor(kRed);
//    TPaveText *textPub1 = new TPaveText(0.146,0.73,0.222,0.836,"brNDC");
//    textPub1 -> SetTextSize(0.045);
...
//    textPub1 -> AddText(Form("Raw yield: %0.3g", S));
//    textPub1 -> SetTextAlign(12);
//    textPub -> Draw("same");
//    textPub1 -> Draw("same");
//    TLegend *legendPub = new TLegend(0.14,0.835, 0.3, 0.926,"","brNDC");
...
//    gStyle->SetLabelSize(.065);
    ...
    hInvMassSignOrig->GetYaxis()->SetTitleOffset(1.3);
    hInvMassSignOrig->GetYaxis()->SetTitleOffset(1.3);

    hInvMassSignOrig->GetXaxis()->SetTitleOffset(1.);
    hInvMassSignOrig->GetYaxis()->CenterTitle(kTRUE);
    hInvMassSignOrig->GetXaxis()->SetTitle("Mass_{K#pi} (GeV/c^{2})");
...
//    hInvMassSignOrig->GetYaxis()->SetTitleSize(0.065);
//    hInvMassSignOrig->GetXaxis()->SetTitleSize(0.065);
//    hInvMassSignOrig->GetYaxis()->SetLabelSize(0.06);
//    hInvMassSignOrig->GetXaxis()->SetLabelSize(0.06);
    ...
    TLegend *legend3 = new TLegend(0.45,0.77, 0.62, 0.87,"","brNDC");
